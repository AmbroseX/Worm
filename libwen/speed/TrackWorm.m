...
switch CalculationMethodSelection
    case 1 % using multiple points
        ...
        start_counting_segment = 7; % n th point to start calculation
        headpoint = 1; % position intra-segment 
    ...
    case 2 % using centroid
        ...
        ignoring_segments_head = 30;      
        com=[mean(Centerline(:,ignoring_segments_head:end,XX),2), mean(Centerline(:,ignoring_segments_head:end,YY),2)]; 
        
    case 3
        segments=1;
        start_counting_segment=1;
        com=zeros(N,2,segments);
end