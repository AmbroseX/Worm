function [speed, stagepos] = queryWormspeed(mcd,worm_length,reference_point_mtd,CalculationMethodSelection,varargin)
    ...
    switch reference_point_mtd
        case 1
            stagepos = zeros(N,2);
            for i = 1:N
                stagepos(i,:) = mcd(i+istart-1).StagePosition.*micronperunit/micronperpxl-mcd(i+istart-1).StageFeedbackTarget;
            end
