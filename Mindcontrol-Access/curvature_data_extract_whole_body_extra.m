...
if j1~=0
    ...
    if j2~=0
        ...
        disp(std(head_curv(max(1,j1-15*frames):max(1,j1-10*frames))));
		
        disp(std(head_curv(max(1,j1-10*frames):max(1,j1-5*frames))));
        
        disp(std(head_curv(max(1,j1-5*frames):j1)));
